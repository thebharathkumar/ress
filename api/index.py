"""
Resume Tailoring System — Vercel Serverless Entry Point
FastAPI + ReportLab + Claude (Blackbox.ai)
"""
import io
import json
import os
...
OUTPUT FORMAT — return ONLY valid JSON, no markdown, no code fences:
{
  ...
  "skills": {
    "Languages": "...", "Backend & APIs": "...", "Databases": "...",
    "Web Applications": "...", "Infrastructure": "...", "Engineering": "...", "Tools": "..."
  },
  "experience": [
    {
      "role": "Job Title", "company": "Company Name", "location": "City, ST",
        ...
        "experience": [
            {
                ...
                "company": "Pace University", "location": "New York, NY",
                "start": "Mar 2025", "end": "Present",
                "bullets": [
            ...
            {
                "role": "Software Development Intern", "company": "Let's Be The Change",
                "location": "Bangalore, India", "start": "Sep 2023", "end": "May 2024",
                "bullets": [
            ...
            },
            {
                ...
                "company": "Compsoft Technologies (Pantechelearning)", "location": "Bangalore, India",
                "start": "Aug 2023", "end": "Sep 2023",
                "bullets": [
            ...
            {
                "role": "Software Engineer Intern", "company": "Alltramatic",
                "location": "New York, NY (Remote)", "start": "Mar 2023", "end": "Apr 2023",
                "bullets": [
        ...
        "projects": [
            {
                ...
                "year": "2025",
                "bullets": ["Multi-tier, scalable web application with synchronous and asynchronous APIs, relational database architecture, Redis caching, CI/CD, and 85%+ test coverage; designed for 24x7 high-availability on AWS."],
            },
            {
                "name": "AI-Powered Web Service | Python, FastAPI, LangChain, React, PostgreSQL, Docker",
                "year": "2025",
                "bullets": ["User-centric web application integrating AI into scalable backend services; RESTful API development, database design, performance optimization, and continuous integration. Paper in preparation."],
            },
        ],
        "education": [
            {"school": "Pace University, Seidenberg School", "location": "New York, NY",
             "degree": "M.S. Computer Science | GPA: 3.86/4.0", "start": "Aug 2024", "end": "May 2026"},
            {"school": "Visvesvaraya Technological University (VTU)", "location": "Bangalore, India",
             "degree": "B.E. Computer Science", "start": "2020", "end": "2024"},
        ],
        "certifications": [
...
async def tailor_resume(req: TailorRequest):
    try:
        ...
        return StreamingResponse(
            ...
            headers={
                "Content-Disposition": 'attachment; filename="Bharath_Kumar_Tailored_Resume.pdf"',
                "X-Pages": str(pages),
                "X-Changes-Summary": changes[:500],
                "Access-Control-Expose-Headers": "X-Pages, X-Changes-Summary",
            },
        )
